...
const Screen2 = ({ navigation }) => {
  const [image, setImage] = useState(require('./assets/vsmartTrang.jpg'));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex: 7, alignItems: 'center', justifyContent: 'center', backgroundColor: '#C4C4C4' }}>
        ...
        <Pressable style={{ margin: 3, width: 60, height: 60, backgroundColor: '#dce8e8' }}
          onPress={() => { setImage(require('./assets/vsmartTrang.jpg')); setMau('Bạc'); }}
        />
        <Pressable style={{ margin: 3, width: 60, height: 60, backgroundColor: 'red' }}
          onPress={() => { setImage(require('./assets/vsmartDo.jpg')); setMau('Đỏ'); }}
        />
        <Pressable style={{ margin: 3, width: 60, height: 60, backgroundColor: 'black' }}
          onPress={() => { setImage(require('./assets/vsmartDen.jpg')); setMau('Đen'); }}
        />
        <Pressable style={{ margin: 3, width: 60, height: 60, backgroundColor: 'blue' }}
          onPress={() => { setImage(require('./assets/vsmartXanh.jpg')); setMau('Xanh'); }}
        />
