...
const Screen1 = ({ navigation }) => {
  const [image, setImage] = useState(require('./assets/vsmart.jpg'));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.pan}>
        ...
        <Text style={{ paddingLeft: 55, fontSize: 15, fontWeight: '700', textDecorationLine: 'line-through', color:'grey' }}>
          1.790.000 đ
        </Text>
      </View>
